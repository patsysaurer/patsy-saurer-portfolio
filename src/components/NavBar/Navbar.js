    ...
    <div className="header">
      ...
      <Link to="hero" spy={true} smooth={true} offset={-100} duration={500} onClick={closeMenu} style={{fontSize: "2.5rem", color:"var(--primary-color)", fontWeight: "bold"}}>PS</Link>
        ...
        <ul className={click ? 'nav-menu active' : 'nav-menu'}>
          ...
          <li className="nav-item">
          <Link to="tech-stack" spy={true} smooth={true} offset={-100} duration={500} onClick={closeMenu}>Tech Stack</Link>
          </li>
          <li className="nav-item">
          ...
          <li className="nav-item">
          <a href="https://www.linkedin.com/in/patsy-saurer/" target="blank">Contact</a>
          </li>
        </ul>
      </nav>
    </div>
